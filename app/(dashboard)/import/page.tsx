...
const downloadTemplate = () => {
  ...
  // EMPLOYES sheet - realistic hiring timeline with pro-rating
  const employeesData = [
    ...
    // January 2024 - Baseline team
    ['E001', '01/01/2024', 'F', '15/06/1985', '01/03/2020', '', 'CDI', '1', 'Directrice RH', 'RH', 'SIEGE', 'Actif'],
    ['E002', '01/01/2024', 'M', '22/11/1988', '15/09/2019', '', 'CDI', '1', 'Développeur Senior', 'IT', 'SIEGE', 'Actif'],
    ['E003', '01/01/2024', 'F', '10/04/1995', '01/06/2021', '', 'CDI', '0.8', 'Comptable', 'FIN', 'SIEGE', 'Actif'],
    ['E004', '01/01/2024', 'M', '05/12/1990', '15/01/2022', '', 'CDD', '1', 'Chef de Projet', 'IT', 'SIEGE', 'Actif'],
    ['E005', '01/01/2024', 'F', '28/08/1992', '10/11/2023', '', 'CDI', '1', 'Marketing Manager', 'COM', 'SIEGE', 'Actif'],
    
    // January 2025 - Continuing employees + new hire at start of month
    ...
    ['E003', '01/01/2025', 'F', '10/04/1995', '01/06/2021', '', 'CDI', '1', 'Comptable Senior', 'FIN', 'SIEGE', 'Actif'], // Promoted to full-time
    ['E004', '01/01/2025', 'M', '05/12/1990', '15/01/2022', '31/01/2025', 'CDD', '1', 'Chef de Projet', 'IT', 'SIEGE', 'Actif'], // Contract ending
    ['E005', '01/01/2025', 'F', '28/08/1992', '10/11/2023', '', 'CDI', '1', 'Marketing Manager', 'COM', 'SIEGE', 'Actif'],
    ['E006', '01/01/2025', 'M', '18/03/1987', '02/01/2025', '', 'CDI', '1', 'Data Analyst', 'IT', 'SIEGE', 'Actif'], // Started Jan 2nd (full month)
    
    // February 2025 - Mid-month hires with pro-rated time
    ['E001', '01/02/2025', 'F', '15/06/1985', '01/03/2020', '', 'CDI', '1', 'Directrice RH', 'RH', 'SIEGE', 'Actif'],
    ['E002', '01/02/2025', 'M', '22/11/1988', '15/09/2019', '15/02/2025', 'CDI', '1', 'Développeur Senior', 'IT', 'SIEGE', 'Inactif'], // Leaves mid-month
    ['E003', '01/02/2025', 'F', '10/04/1995', '01/06/2021', '', 'CDI', '1', 'Comptable Senior', 'FIN', 'SIEGE', 'Actif'],
    ['E005', '01/02/2025', 'F', '28/08/1992', '10/11/2023', '', 'CDI', '1', 'Marketing Manager', 'COM', 'SIEGE', 'Actif'],
    ['E006', '01/02/2025', 'M', '18/03/1987', '02/01/2025', '', 'CDI', '1', 'Data Analyst', 'IT', 'SIEGE', 'Actif'],
    ['E007', '01/02/2025', 'F', '25/09/1996', '10/02/2025', '', 'Stage', '0.68', 'Stagiaire Finance', 'FIN', 'SIEGE', 'Actif'], // Started Feb 10th (20/29 days = 0.68)
    ['E008', '01/02/2025', 'M', '12/07/1989', '15/02/2025', '', 'Alternance', '0.52', 'Développeur Junior', 'IT', 'SIEGE', 'Actif'], // Started Feb 15th (15/29 days = 0.52)
    ['E009', '01/02/2025', 'F', '30/01/1994', '20/02/2025', '', 'CDD', '0.34', 'Assistante RH', 'RH', 'SIEGE', 'Actif'] // Started Feb 20th (10/29 days = 0.34)
  ]
  XLSX.utils.book_append_sheet(wb, XLSX.utils.aoa_to_sheet(employeesData), 'EMPLOYES')
  
  // REMUNERATION sheet - pro-rated salaries for partial months
  const remunerationData = [
    ['matricule', 'mois_paie', 'salaire_de_base', 'primes_fixes', 'primes_variables', 'cotisations_sociales'],
    
    // January 2024
    ['E001', '01/01/2024', '5200', '400', '800', '1560'],
    ['E002', '01/01/2024', '4200', '250', '600', '1260'],
    ['E003', '01/01/2024', '2400', '150', '200', '690'], // Part-time salary
    ['E004', '01/01/2024', '3800', '200', '400', '1140'],
    ['E005', '01/01/2024', '4000', '300', '700', '1200'],
    
    // January 2025
    ['E001', '01/01/2025', '5500', '500', '1200', '1650'],
    ['E002', '01/01/2025', '4500', '300', '800', '1350'],
    ['E003', '01/01/2025', '3200', '200', '400', '960'], // Full-time now
    ['E004', '01/01/2025', '3800', '200', '200', '1140'], // Last month, reduced bonus
    ['E005', '01/01/2025', '4200', '350', '600', '1260'],
    ['E006', '01/01/2025', '4000', '0', '0', '1200'], // New hire, no bonus yet
    
    // February 2025 - Pro-rated for partial months
    ['E001', '01/02/2025', '5500', '500', '1000', '1650'],
    ['E002', '01/02/2025', '2250', '150', '300', '675'], // Left mid-month (half pay)
    ['E003', '01/02/2025', '3200', '200', '500', '960'],
    ['E005', '01/02/2025', '4200', '350', '700', '1260'],
    ['E006', '01/02/2025', '4000', '100', '300', '1200'],
    ['E007', '01/02/2025', '408', '0', '0', '122'], // Intern: 600 * 0.68 (started Feb 10)
    ['E008', '01/02/2025', '936', '0', '0', '281'], // Apprentice: 1800 * 0.52 (started Feb 15)
    ['E009', '01/02/2025', '476', '0', '0', '143'] // Temp: 1400 * 0.34 (started Feb 20)
  ]
  XLSX.utils.book_append_sheet(wb, XLSX.utils.aoa_to_sheet(remunerationData), 'REMUNERATION')
  
  // ABSENCES sheet - only for employees present during the period
  const absencesData = [
    ['matricule', 'type_absence', 'date_debut', 'date_fin'],
    
    // January 2024
    ['E001', 'Formation', '15/01/2024', '16/01/2024'],
    ['E003', 'Maladie', '22/01/2024', '24/01/2024'],
    ['E005', 'Congés payés', '25/01/2024', '26/01/2024'],
    
    // January 2025
    ['E001', 'Congés payés', '08/01/2025', '12/01/2025'],
    ['E002', 'Maladie', '20/01/2025', '22/01/2025'],
    ['E003', 'Formation', '25/01/2025', '26/01/2025'],
    ['E004', 'Formation', '27/01/2025', '31/01/2025'], // Last week before leaving
    
    // February 2025 - Only employees present can have absences
    ['E001', 'RTT', '14/02/2025', '14/02/2025'],
    ['E003', 'Congés payés', '17/02/2025', '21/02/2025'],
    ['E005', 'Formation', '24/02/2025', '25/02/2025'],
    ['E006', 'Maladie', '10/02/2025', '11/02/2025'],
    ['E007', 'Formation', '26/02/2025', '28/02/2025'] // Intern training (after start date)
  ]
  ...
  const organisationData = [
    ...
    ['SIEGE', 'Siège Social', 'COM', 'Commercial']
  ]
  ...
  XLSX.writeFile(wb, `template_import_rh_prorated_${new Date().toISOString().split('T')[0]}.xlsx`)
  addLog('Template avec calculs pro-rata téléchargé', 'success')
}
