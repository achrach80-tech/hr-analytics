...
export default function CompanyLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ✅ CORRECTION : Aussi stocker le token pour compatibilité avec page vision
      ...
      // ✅ CORRECTION : Rediriger vers l'URL sauvegardée si elle existe
      const redirectUrl = localStorage.getItem('redirect_after_login')
      
      if (redirectUrl) {
        // Nettoyer la clé avant de rediriger
