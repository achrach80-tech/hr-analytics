...
import { BackendOptimizedProcessor } from '../optimized/BackendOptimizedProcessor'
import type { 
  ProcessedData, 
  ImportProgress, 
  ValidationResult, 
...
export const useImport = () => {
  ...
  const processorRef = useRef<BackendOptimizedProcessor | null>(null)
  ...
  const processImport = useCallback(async (
    ...
    try {
      ...
      processorRef.current = new BackendOptimizedProcessor()
