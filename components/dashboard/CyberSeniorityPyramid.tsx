...
export const CyberSeniorityPyramid: React.FC<CyberSeniorityPyramidProps> = ({ data }) => {
  // Construction des groupes d'ancienneté (du plus ancien au plus récent)
  const seniorityGroups = [
    { label: '> 10 ans', hommes: data.anciennetePlus10H || 0, femmes: data.anciennetePlus10F || 0 },
    { label: '5-10 ans', hommes: data.anciennete510H || 0, femmes: data.anciennete510F || 0 },
    { label: '3-5 ans', hommes: data.anciennete35H || 0, femmes: data.anciennete35F || 0 },
    { label: '1-3 ans', hommes: data.anciennete13H || 0, femmes: data.anciennete13F || 0 },
    { label: '< 1 an', hommes: data.anciennete01H || 0, femmes: data.anciennete01F || 0 }
  ]
