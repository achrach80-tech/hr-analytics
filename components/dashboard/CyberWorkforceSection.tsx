 ...
 * - ✅ Carte secondaire pour taux annualisé
 * - ✅ Tooltip explicatif sur la différence mensuel/annualisé
 */
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <CyberKPICard
          ...
          subtitle="Employés fin de période"
